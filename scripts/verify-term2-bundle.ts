...
const TARGET_SKILLS = [
  {
    ...
    expectedTopicId: "math_topic_complex_numbers",
    title: "الأعداد المركبة: الشكل الأسي ودستور دو موافر",
  },
  {
    skillId: "math_space_geometry_plane_line",
    expectedTopicId: "math_topic_space_geometry",
    title: "الهندسة في الفضاء: معادلة المستوي والتمثيل الوسيطي لمستقيم",
  },
  {
    skillId: "math_integration_by_parts_area",
    expectedTopicId: "math_topic_integration",
    title: "الحساب التكاملي: المكاملة بالتجزئة وحساب المساحات",
  },
];

console.log("==================================================================");
console.log("  VERIFYING MATH_TERM2_SCIENCES_BUNDLE INTEGRATION");
console.log("==================================================================\n");
...
console.log("==================================================================");
if (allPassed) {
  console.log("🎉 ALL 3 SKILLS IN MATH_TERM2_SCIENCES_BUNDLE FULLY VERIFIED!");
} else {
