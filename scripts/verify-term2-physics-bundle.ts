...
const TARGET_SKILLS = [
  {
    ...
    expectedTopicId: "physics_topic_circuits",
    title: "الاهتزازات الكهربائية الحرة: دارة RLC والتفريغ المتخامد وغير المتخامد",
  },
  {
    skillId: "phys_mechanical_oscillations_spring",
    expectedTopicId: "physics_topic_mechanics",
    title: "الاهتزازات الميكانيكية: النواس المرن وتطبيق القانون الثاني لنيوتن",
  },
  {
    skillId: "phys_esterification_hydrolysis_equilibrium",
    expectedTopicId: "physics_topic_esterification",
    title: "الكيمياء العضوية: تفاعلات الأسترة والإماهة، المردود ومراقبة السرعة",
  },
];

console.log("==================================================================");
console.log("  VERIFYING PHYSICS_TERM2_SCIENCES_BUNDLE INTEGRATION");
console.log("==================================================================\n");
...
console.log("==================================================================");
if (allPassed) {
  console.log("🎉 ALL 3 SKILLS IN PHYSICS_TERM2_SCIENCES_BUNDLE FULLY VERIFIED!");
} else {
