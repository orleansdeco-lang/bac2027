...
const PLANNED_MULTI_STREAM_ITEMS: CoverageSkillItem[] = [
  ...
  // ===========================================================================
  // STREAM: MATHÉMATIQUES (9 PRODUCTION BATCH 03 PUBLISHED SKILLS)
  // ===========================================================================
  {
    ...
    streamId: "math",
    topicId: "math_topic_arithmetic_theorems",
    title_ar: "مبرهنة فيرما الصغرى وحساب باقي القسمة للقوى الكبيرة",
    title_fr: "Petit théorème de Fermat et réduction modulaire des grandes puissances",
    objective_ar: "تطبيق مبرهنة فيرما الصغرى a^(p-1) ≡ 1 [p] لحساب بواقي قسمة القوى الكبيرة واختزال الحسابات التوافقية في الأعداد الأولية.",
    objective_fr: "Appliquer le petit théorème de Fermat pour réduire les grandes puissances modulo un nombre premier.",
    bloomLevel: "apply",
    status: "PUBLISHED",
    lifecycleState: "PUBLISHED",
    hasLesson: true,
  ...
  },
  {
    ...
    streamId: "math",
    topicId: "math_topic_divisibility_congruences",
    title_ar: "أنظمة التعداد وتعيين أساس نظام العد والتحويل بين القواعد",
    title_fr: "Systèmes de numération, changement de base et détermination de base",
    objective_ar: "كتابة الأعداد في أنظمة التعداد المختلفة، التحويل إلى النظام العشري، وتعيين أساس مجهول لنظام عد من معادلات معطاة.",
    objective_fr: "Manipuler l'écriture positionnelle des entiers en base quelconque et résoudre des équations de base.",
    bloomLevel: "apply",
    status: "PUBLISHED",
    lifecycleState: "PUBLISHED",
    hasLesson: true,
  ...
  },
  {
    ...
    streamId: "math",
    topicId: "math_topic_complex_algebra",
    title_ar: "تحليل كثيرات الحدود ذات المعاملات الحقيقية في C وحل المعادلات",
    title_fr: "Factorisation des polynômes dans C et racines complexes conjuguées",
    objective_ar: "حل المعادلات التكعيبية والرباعية في C بتعيين الجذور التخيلية الصرفة أو الحقيقية، والتحليل إلى جداء عوامل والاستفادة من ترافق الجذور.",
    objective_fr: "Factoriser des polynômes dans C en exploitant les racines imaginaires pures et les racines conjuguées.",
    bloomLevel: "apply",
    status: "PUBLISHED",
    lifecycleState: "PUBLISHED",
    hasLesson: true,
  ...
  },
  {
    ...
    streamId: "math",
    topicId: "math_topic_integration_primitives",
    title_ar: "تفكيك الكسور والتكاملات الكسرية النموذجية u'/u و u'/u²",
    title_fr: "Décomposition en éléments simples et primitives des fractions rationnelles",
    objective_ar: "تعيين الدوال الأصلية للكسور الناطقة بتفكيكها إلى عناصر بسيطة وتوظيف الأشكال النموذجية u'/u و u'/u².",
    objective_fr: "Décomposer une fraction rationnelle en éléments simples pour déterminer ses primitives.",
    bloomLevel: "apply",
    status: "PUBLISHED",
    lifecycleState: "PUBLISHED",
    hasLesson: true,
  ...
  },
  {
    ...
    streamId: "math",
    topicId: "math_topic_integration_primitives",
    title_ar: "الدوال المعرفة بتكامل بحدود متغيرة F(x) = ∫_a^x f(t)dt ودراستها",
    title_fr: "Fonctions définies par une intégrale à bornes variables F(x) = ∫_a^x f(t)dt",
    objective_ar: "دراسة الدالة المعرفة بتكامل F(x) = ∫_a^x f(t)dt، إثبات اشتقاقيتها، تعيين F'(x) = f(x)، ودراسة اتجاه تغيرها وحصرها.",
    objective_fr: "Étudier les propriétés, la dérivabilité F'(x) = f(x) et le sens de variation d'une fonction définie par une intégrale.",
    bloomLevel: "apply",
    status: "PUBLISHED",
    lifecycleState: "PUBLISHED",
    hasLesson: true,
  ...
  },
  {
    ...
    title_fr: "Équations différentielles linéaires du second ordre ay'' + by' + cy = 0",
    objective_ar: "حل المعادلات التفاضلية الخطية من الرتبة الثانية ay'' + by' + cy = 0 بمناقشة إشارة المميز Δ وتعيين الحل الخاص المستوفي للشروط الابتدائية.",
    objective_fr: "Résoudre les équations différentielles du second ordre selon le signe du discriminant caractéristique.",
    bloomLevel: "apply",
    status: "PUBLISHED",
    lifecycleState: "PUBLISHED",
    hasLesson: true,
  ...
  },
  {
    ...
    streamId: "math",
    topicId: "math_topic_space_geometry",
    title_ar: "التمثيل الوسيطي للمستقيم في الفضاء وتقاطع مستقيم ومستو والمسقط العمودي",
    title_fr: "Représentation paramétrique de droite, intersection droite-plan et projection orthogonale",
    objective_ar: "كتابة التمثيل الوسيطي لمستقيم في الفضاء، تعيين نقطة تقاطعه مع مستو، وحساب إحداثيات المسقط العمودي لنقطة على مستو.",
    objective_fr: "Déterminer la représentation paramétrique d'une droite, son point d'intersection avec un plan et le projeté orthogonal.",
    bloomLevel: "apply",
    status: "PUBLISHED",
    lifecycleState: "PUBLISHED",
    hasLesson: true,
  ...
  },
  {
    ...
    streamId: "math",
    topicId: "math_topic_space_geometry",
    title_ar: "معادلة سطح الكرة في الفضاء وتقاطع سطح كرة مع مستو",
    title_fr: "Équation cartésienne de sphère et intersection sphère-plan",
    objective_ar: "تعيين معادلة سطح الكرة، دراسة الوضع النسبي لسطح كرة ومستو، وتعيين مركز ونصف قطر دائرة التقاطع في حالة d < R.",
    objective_fr: "Établir l'équation d'une sphère, étudier l'intersection avec un plan et déterminer le cercle d'intersection.",
    bloomLevel: "apply",
    status: "PUBLISHED",
    lifecycleState: "PUBLISHED",
    hasLesson: true,
  ...
  },
  {
    ...
    streamId: "math",
    topicId: "math_topic_combinatorics_bernoulli",
    title_ar: "المتغيرات العشوائية والأمل الرياضياتي والتباين والانحراف المعياري",
    title_fr: "Variables aléatoires, espérance mathématique, variance et écart-type",
    objective_ar: "تعريف المتغير العشوائي، تعيين قانون احتماله، وحساب الأمل الرياضياتي E(X) والتباين V(X) والانحراف المعياري σ(X) وتفسيرها.",
    objective_fr: "Déterminer la loi d'une variable aléatoire, calculer l'espérance, la variance et l'écart-type.",
    bloomLevel: "apply",
    status: "PUBLISHED",
    lifecycleState: "PUBLISHED",
    hasLesson: true,
