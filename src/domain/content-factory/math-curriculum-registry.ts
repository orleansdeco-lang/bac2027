...
export const MATH_3AS_TOPICS: Record<string, MathCurriculumTopic> = {
  math_topic_divisibility_congruences: {
    ...
    skillIds: ["math_m_arithmetic_congruence", "math_m_numeral_systems"],
    order: 1,
  ...
  math_topic_arithmetic_theorems: {
    ...
    skillIds: ["math_m_bezout_diophantine", "math_m_gauss_prime_factors", "math_m_fermat_little_theorem"],
    order: 2,
    isSpecificToMathStream: true,
  },
  math_topic_complex_algebra: {
    ...
    skillIds: ["math_m_complex_algebraic_trig", "math_m_roots_of_unity", "math_m_complex_argument_loci", "math_m_complex_polynomials_factorization"],
    order: 3,
  ...
  math_topic_integration_primitives: {
    ...
    skillIds: ["math_m_integration_parts", "math_m_primitives_rational_fractions", "math_m_integral_functions_variable_bounds"],
    order: 7,
    isSpecificToMathStream: false,
  },
  math_topic_differential_equations: {
    ...
    skillIds: ["math_m_differential_equations", "math_m_second_order_differential_equations"],
    order: 8,
    isSpecificToMathStream: false,
  },
  math_topic_sequences_convergence: {
  ...
  math_topic_space_geometry: {
    ...
    skillIds: ["math_m_space_geometry_planes", "math_m_space_lines_intersections", "math_m_space_spheres_equations"],
    order: 10,
    isSpecificToMathStream: false,
  },
  math_topic_combinatorics_bernoulli: {
    ...
    skillIds: ["math_m_combinatorics_bernoulli", "math_m_conditional_probability_trees", "math_m_total_probability", "math_m_random_variables_expectation"],
    order: 11,
    isSpecificToMathStream: false,
  },
};
